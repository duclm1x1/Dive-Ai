 ...
 */
export async function fetchGitHubDocs(repo, query) {
 ...
 */
async function getCachedDoc(cachePath) {
    try {
 ...
 * Cache documentation
 */
async function cacheDoc(cachePath, doc) {
 ...
 */
export async function fetchDocumentation(owner, repo, path, branch) {
