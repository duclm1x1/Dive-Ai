...
DEFAULT_KEYS = {
    "V98API_KEY": os.getenv("V98API_KEY", "sk-dBWRD0cFgIBLf36nPAeuMRNSeFvvLfDtYS1mbR3RIpVSoR7y"),
...
def verify_setup():
    ...
    try:
        ...
        if not v98_key:
            print("⚠️  WARNING: V98API_KEY not found in .env")
        else:
            print(f"✅ V98API_KEY loaded: {v98_key[:20]}...")
        
        if not aicoding_key:
            print("⚠️  WARNING: AICODING_API_KEY not found in .env")
        else:
            print(f"✅ AICODING_API_KEY loaded: {aicoding_key[:20]}...")
