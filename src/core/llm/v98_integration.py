...
V98_API_KEY = os.getenv("V98_API_KEY", "sk-dBWRD0cFgIBLf36nPAeuMRNSeFvvLfDtYS1mbR3RIpVSoR7y")

# Aicoding Configuration (Alternative)
AICODING_BASE_URL = os.getenv("AICODING_API_URL", "https://aicoding.io.vn/v1")
AICODING_API_KEY = os.getenv("AICODING_API_KEY", "sk-dev-0kgTls1jmGOn3K4Fdl7Rdudkl7QSCJCk")
