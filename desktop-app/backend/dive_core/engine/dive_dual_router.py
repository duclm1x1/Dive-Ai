...
try:
    from dive_core.engine.dive_complexity_analyzer import ComplexityLevel
    from dive_core.engine.dive_strategy_selector import ExecutionStrategy
    from dive_core.workflow.dive_thinking_engine import ThinkingResult, ThinkingTrace
except ImportError:
