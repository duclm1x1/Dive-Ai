...
import { ProviderHealthDashboard } from '@/components/monitor/ProviderHealthDashboard';
import { ProviderSpeedTest } from './ProviderSpeedTest';
import { OptimizationModeSettings } from './OptimizationModeSettings';
import { ProviderPerformanceCharts } from './ProviderPerformanceCharts';
import { AlertsManagement } from './AlertsManagement';
import { PerformanceExport } from './PerformanceExport';
import { OptimizationRules } from './OptimizationRules';
import { AntiGravityQuota } from './AntiGravityQuota';
...
export function SettingsTab() {
  ...
  const [activeSettingsTab, setActiveSettingsTab] = useState('runtime');
  ...
  return (
    <Tabs value={activeSettingsTab} onValueChange={setActiveSettingsTab} className="w-full p-6">
      <TabsList className="grid w-full max-w-6xl mx-auto grid-cols-10 mb-8">
        ...
        <TabsTrigger value="ag-quota">AG Quota</TabsTrigger>
      </TabsList>
      
      <TabsContent value="runtime" className="max-w-3xl mx-auto space-y-6">
      ...
      <TabsContent value="optimizer" className="max-w-3xl mx-auto">
        <OptimizationModeSettings />
      </TabsContent>
      ...
      <TabsContent value="charts" className="max-w-4xl mx-auto">
        <ProviderPerformanceCharts />
      </TabsContent>
      
      <TabsContent value="alerts" className="max-w-4xl mx-auto">
        <AlertsManagement />
      </TabsContent>
      
      <TabsContent value="export" className="max-w-4xl mx-auto">
        <PerformanceExport />
      </TabsContent>
      
      <TabsContent value="rules" className="max-w-4xl mx-auto">
        <OptimizationRules />
      </TabsContent>
      
      <TabsContent value="ag-quota" className="max-w-4xl mx-auto">
        <AntiGravityQuota />
      </TabsContent>
    </Tabs>
  );
