    ...
    <div className="p-4 space-y-4">
      ...
      <div className="glass-card p-4 border border-primary/20">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-2xs text-muted-foreground uppercase">Total Time</span>
        </div>
        <div 
      ...
      <div className="space-y-3">
        <div className="text-2xs text-muted-foreground uppercase font-semibold">How Time Was Spent</div>
