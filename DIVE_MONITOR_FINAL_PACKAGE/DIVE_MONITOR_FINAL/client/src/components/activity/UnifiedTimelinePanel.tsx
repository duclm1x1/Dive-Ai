...
import { toFriendly, getFriendlyDescription, getIcon } from '@/lib/languageMapping';
...
const stepIcons: Record<string, React.ElementType> = {
  'Planning Approach': GitBranch,
  'Creating Plan': ListTree,
  'Searching Files': Search,
  'Using Tool': Terminal,
  'Connecting Evidence': Link2,
  'Creating Report': FileText,
};
